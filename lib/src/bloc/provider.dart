...
class Provider extends InheritedWidget {
  ...
  static LoginBloc of ( BuildContext context ) => context.dependOnInheritedWidgetOfExactType<Provider>().loginBloc;
  static ProductosBloc productosBloc ( BuildContext context ) => context.dependOnInheritedWidgetOfExactType<Provider>()._productosBloc;
